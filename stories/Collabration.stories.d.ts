...
import { Sheet, Op, Selection } from "@evidential-fortune-sheet/core";
declare const _default: import("@storybook/types").ComponentAnnotations<import("@storybook/react/dist/types-0a347bb9").R, import("@evidential-fortune-sheet/core").Settings & {
    ...
    getCellsByRange: (range: Selection, options?: import("../packages/core/src/api").CommonOptions) => (import("@evidential-fortune-sheet/core").Cell | null)[][];
...
export declare const Example: import("@storybook/types").AnnotatedStoryFn<import("@storybook/react/dist/types-0a347bb9").R, import("@evidential-fortune-sheet/core").Settings & {
    onChange?: ((data: Sheet[]) => void) | undefined;
    onOp?: ((op: Op[]) => void) | undefined;
} & React.RefAttributes<{
    applyOp: (ops: Op[]) => void;
